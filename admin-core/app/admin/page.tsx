      ...
      >
        <div className="px-6 py-7 border-b" style={{ borderColor: "rgba(255,255,255,0.1)" }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-black text-base leading-none text-white">PureBin LV</p>
        ...
        <nav className="flex-1 space-y-6 px-3 py-6">
          {["operations", "config", "danger"].map((section) => {
            ...
            return (
              <div key={section}>
                <p className="px-4 py-2 text-xs font-semibold uppercase tracking-widest text-slate-400 mb-2">
                  {sectionLabel}
                </p>
                    ...
                    return [
                      ...
                      <Link
                        ...
                        className={`flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium transition-all ${
                          leadsActive ? "text-white bg-white/10" : "text-slate-400 hover:bg-white/5 hover:text-white"
                        }`}
                      >
                        <FileText size={18} />
                        Leads
        ...
        <div
          className="md:hidden fixed bottom-0 left-0 right-0 z-50 flex border-t px-1 py-1 overflow-x-auto"
          ...
          {tabs.flatMap((item) => {
            ...
            const sectionButton = (
              <button
                ...
                className={`flex flex-col items-center gap-0.5 rounded-lg py-2 px-2 text-xs transition-all shrink-0 ${
                  activeSection === item.id ? "text-[#0ea5e9] bg-white/5" : "text-slate-500"
                }`}
              >
                <Icon size={16} />
            ...
            return [
              ...
              <Link
                ...
                href="/admin/leads"
                className={`flex flex-col items-center gap-0.5 rounded-lg py-2 px-2 text-xs transition-all shrink-0 ${
                  leadsActive ? "text-[#0ea5e9] bg-white/5" : "text-slate-500"
                }`}
              >
                <FileText size={16} />
        ...
        <div className="flex-1 overflow-auto pb-20 md:pb-0">
          <div className="px-4 md:px-10 py-6">
            ...
            {activeSection === "quotes" ? (
              <>
                <div className="mb-8">
                  ...
                  <p className="text-sm text-slate-500 mt-1">Review, edit, and convert saved quotes into scheduled jobs.</p>
                </div>
            ...
            {activeSection === "reps" ? (
              <>
                <div className="mb-8">
                  <p className="text-xs font-semibold uppercase tracking-widest text-[#0ea5e9] mb-1">OPERATIONS</p>
                  <h1 className="text-3xl font-bold text-slate-900">Reps</h1>
                  <p className="text-sm text-slate-500 mt-1">Manage knockers and field crew. Toggle active status, view performance.</p>
                </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">Add, edit, or delete customer reviews displayed on your public site.</p>
          </div>
          <Card className="shadow-lg border border-slate-200 bg-white text-slate-900">
            <CardHeader>
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">Track scheduled and active service appointments across the team.</p>
          </div>
          <div className="space-y-6">
            <Card className="shadow-lg border border-slate-200 bg-white text-slate-900">
              <CardHeader>
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-slate-900">Email</h1>
            <p className="text-sm text-slate-500 mt-1">Send messages to leads and manage contacts.</p>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">Create and manage admin, rep, and tech user accounts.</p>
          </div>
          <UsersAdminPanel />
          </>
          ) : null}
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">Manage rep and tech availability windows.</p>
          </div>
          <ScheduleAdminLinks />
          </>
          ) : null}
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">Set pane type costs, add-on surcharges, and story-level rates.</p>
          </div>
          <Card className="shadow-lg border border-slate-200 bg-white text-slate-900">
            <CardHeader>
